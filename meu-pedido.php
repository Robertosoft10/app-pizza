  ...
  <br>  <br>  <br>
    <section id="cardapio" class="menu section">
      ...
      <div class="container isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
        ...
        <tbody>
          <?php
            $sql = "SELECT * FROM tb_pedidos P JOIN tb_clientes C ON P.clienteCodigo = C.clienteId WHERE clienteId = '$clienteId'";
            $lista = $conexao->query($sql);
            $cliente = $lista->fetch(PDO::FETCH_ASSOC);
          if(isset($cliente['clienteCodigo'])){
           ?>
          <tr>
      ...
      <a href="detalhe-peido.php?pedidoId=<?= $cliente['pedidoId'];?>" class="btn btn-default" id="btn-geral">Detalhe do Pedido </a>
    <?php }else{?>
      <div class="alert alert-danger" role="alert">
        Não há pedido em seu nome
      </div>
      <!-- fim alert -->
    <?php } ?>
      </div>
