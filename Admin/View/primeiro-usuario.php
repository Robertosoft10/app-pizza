                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="../Controller/criarUsuarioPrimario.php" method="post">
                                      <div class="form-group">
                                          <input type="text" class="form-control form-control-user"
                                              placeholder="Nome de Usuário" name="usuarioNome" required>
                                      </div>
                                      <div class="form-group">
                                          <input type="number" class="form-control form-control-user"
                                              placeholder="Cpf de Usuário" name="usuarioCpf" required>
                                      </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                placeholder="E-mail de Usuário" name="usuarioEmail" required>
                                        </div>

                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                     placeholder="Senha de Senha" name="usuarioSenha" required>
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="View/primeiro-usuario.php" href="/../app-pizza/Admin/index.php">Voltar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
